# -------------------------------------------------------------------
# Full moment tensor inversion with Carl Tape's method and the stored SGT database.
#
# refs
...
def DCreate_Triple(colatitude, longitude):
    '''
    * Create the normalized triple according to the colat. and long. in the Lune.
